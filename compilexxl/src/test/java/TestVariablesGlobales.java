...
public class TestVariablesGlobales {
    ...
    public static void main(String[] args) {
        ...
        // Variables globales
        Item i = new Item("i", "int", CategorieSymbole.GLOBAL);
        i.setVal(10);
        tds.ajouter(i);

        Item j = new Item("j", "int", CategorieSymbole.GLOBAL);
        j.setVal(20);
        tds.ajouter(j);

        Item k = new Item("k", "int", CategorieSymbole.GLOBAL);
        tds.ajouter(k);

        Item l = new Item("l", "int", CategorieSymbole.GLOBAL);
        tds.ajouter(l);
